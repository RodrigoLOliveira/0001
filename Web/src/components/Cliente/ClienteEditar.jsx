...
export class ClienteEditar extends Component 
{
    constructor(props)
    {
        super(props)
        ...
        this.id = props?.history?.location?.search.replace("?id=","")
            ...
            <div className="p-col-12">
                <div className="card">
                    ...
                    <div className="p-field p-col-6">
                        ...
                        <InputText id="email" value={this.state.Email} className="p-d-block w-100" readOnly />
                    </div>
                    <div className="p-field p-col-6">
                    ...
                    <div className="p-field p-col-6">
                        <Button  onClick={() => this.submit()} label="Atualizar dados do cliente" /> 
                    </div>
                </div>
            </div>
        </div>
